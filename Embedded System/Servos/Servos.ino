...
void setup() {
    ...
    // pinMode(LEFT_GATE, INPUT_PULLUP);
    // pinMode(RIGHT_GATE, INPUT_PULLUP);
    // pinMode(RIGHT_FRONT_LSW, INPUT_PULLUP);
    // pinMode(RIGHT_REAR_LSW, INPUT_PULLUP);
    // pinMode(LEFT_FRONT_LSW, INPUT_PULLUP);
    // pinMode(LEFT_REAR_LSW, INPUT_PULLUP);
...
// void Home_Blank_Grippers(){

//   // Stop all DC Motors
//   digitalWrite(LATCH, LOW);
//   shiftOut(DS, CLK, MSBFIRST, 0b00000000);
//   digitalWrite(LATCH, HIGH);

//   // Move Left gripper all way back 
//   while (digitalRead(LEFT_REAR_LSW)==1){
//     digitalWrite(LATCH, LOW);
//     shiftOut(DS, CLK, MSBFIRST, 0b0100000);
//     digitalWrite(LATCH, HIGH);
//   }

//   // Stop all DC Motors
//   digitalWrite(LATCH, LOW);
//   shiftOut(DS, CLK, MSBFIRST, 0b0000000);
//   digitalWrite(LATCH, HIGH);

//   // Move Right gripper all way back 
//   while (digitalRead(RIGHT_REAR_LSW)==1){
//     digitalWrite(LATCH, LOW);
//     shiftOut(DS, CLK, MSBFIRST, 0b0000100);
//     digitalWrite(LATCH, HIGH);
//   }
